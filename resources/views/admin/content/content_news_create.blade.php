                                ...
                                <div id="newsTabContent" class="tab-content">
                                    <div role="tabpanel" class="tab-pane fade active in" id="tab_content1" aria-labelledby="element-tab">
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-5 col-sm-5 col-xs-5 to_left">
                                                <input id="video_of_day" class="js-switch form-control col-md-7 col-xs-12" minlength="3" name="video_of_day" type="checkbox" @if (old('video_of_day') == 'on')  checked @endif>
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-6">
                                                <input id="tags_1" class="form-control col-md-6 col-xs-6 tags" name="tags" type="text" value="{{old('tags')}}">
                                            ...
                                            <div id="image_input_container">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-6">
                                                        ...
                                                        <div>
                                                            <input id="image_1_caption" type="text" name="image_1_caption" class="form-control col-md-6 col-xs-6" placeholder="Caption" />
                                                        </div>
