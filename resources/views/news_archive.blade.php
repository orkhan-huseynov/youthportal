            ...
            <div class="col-sm-12 col-md-12">
                <div class="row">
                    <div class="col-sm-12 col-md-12 news_category_container hover_class">
                        <a href="#"><p><span class="news_category_span">@if($lang == 'az') Xəbərlər arxivi @else Архив новостей @endif - {{ $date->format('d.m.Y') }} </span></p></a>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-12 col-md-12 popular_news_container">
                        @forelse($section_news as $news_s)
                            <div class="row">
                        ...
                        @empty
                            <div class="row">
                                <div class="col-md-12 col-lg-12 popular_inner">
                                    {{ ($lang == 'az')? 'Gostərdiyiniz tarixdə xəbər tapilmayıb' : 'Новостей на указанную дату не найдено'}}
                                </div>
                            </div>
                        @endforelse
                    </div>
