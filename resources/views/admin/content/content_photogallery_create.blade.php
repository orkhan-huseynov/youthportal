        ...
        <div class="row">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <form id="PhotogalleryCreateForm" class="form-horizontal form-label-left" action="{{url('admin/content-news/'.$lang)}}" method="post" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            ...
                            <div class="" role="tabpanel" data-example-id="togglable-tabs">
                                ...
                                <div id="newsTabContent" class="tab-content">
                                    <div role="tabpanel" class="tab-pane fade active in" id="tab_content1" aria-labelledby="element-tab">
                                        ...
                                        <div class="item form-group">
                                            <div class="row">
                                                <label class="control-label col-md-1 col-sm-1 col-xs-1" for="photo">Cover Photo</label>
                                                <div class="col-md-6 col-sm-6 col-xs-6">
