                    ...
                    <div class="x_content">
                        <form class="form-horizontal form-label-left" action="{{url('admin/system-users/')}}" method="post">
                            ...
                            <div class="item form-group {{$errors->has('surname')?'has-error':''}}">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="surname" class="form-control col-md-7 col-xs-12" minlength="3" name="surname" required type="text" value="{{old('surname')}}">
                            ...
                            <div class="item form-group {{$errors->has('lastname')?'has-error':''}}">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="lastname" class="form-control col-md-7 col-xs-12" minlength="3" name="lastname" type="text" value="{{old('lastname')}}">
