                                ...
                                <div class="" role="tabpanel" data-example-id="togglable-tabs">
                                    ...
                                    <div id="newsTabContent" class="tab-content">
                                        <div role="tabpanel" class="tab-pane fade active in" id="tab_content1" aria-labelledby="element-tab">
                                            ...
                                            <div class="item form-group">
                                                <label class="control-label col-md-1 col-sm-1 col-xs-1" for="tags_1">Tags</label>
                                                <div class="col-md-6 col-sm-6 col-xs-6">
                                                    <input id="tags_1" class="form-control col-md-6 col-xs-6 tags" name="tags" type="text" value="{{old('tags', $news->tags)}}">
                                                    <span class="col-md-5 col-xs-2 text-danger">{{$errors->first('tags')}}</span>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div id="image_input_container">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6 col-sm-6 col-xs-6">
                                                            ...
                                                            <div>
                                                                <input id="image_1_caption" type="text" name="image_1_caption" class="form-control col-md-6 col-xs-6" placeholder="Caption" value="{{old('image_1_caption', $news->image_1_caption)}}" />
                                                            </div>
                                                    ...
                                                    @if ($news->image_2 != '')
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6 col-sm-6 col-xs-6">
                                                                ...
                                                                <div>
                                                                    <input id="image_2_caption" type="text" name="image_2_caption" class="form-control col-md-6 col-xs-6" placeholder="Caption" value="{{old('image_2_caption', $news->image_2_caption)}}" />
                                                                </div>
                                                    ...
                                                    @if ($news->image_3 != '')
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6 col-sm-6 col-xs-6">
                                                                ...
                                                                <div>
                                                                    <input id="image_3_caption" type="text" name="image_3_caption" class="form-control col-md-6 col-xs-6" placeholder="Caption" value="{{old('image_3_caption', $news->image_3_caption)}}" />
                                                                </div>
                                                    ...
                                                    @if ($news->image_4 != '')
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6 col-sm-6 col-xs-6">
                                                                ...
                                                                <div>
                                                                    <input id="image_4_caption" type="text" name="image_4_caption" class="form-control col-md-6 col-xs-6" placeholder="Caption" value="{{old('image_4_caption', $news->image_4_caption)}}" />
                                                                </div>
                                                    ...
                                                    @if ($news->image_5 != '')
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6 col-sm-6 col-xs-6">
                                                                ...
                                                                <div>
                                                                    <input id="image_5_caption" type="text" name="image_5_caption" class="form-control col-md-6 col-xs-6" placeholder="Caption" value="{{old('image_5_caption', $news->image_5_caption)}}" />
                                                                </div>
                                                    ...
                                                    @if ($news->image_6 != '')
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6 col-sm-6 col-xs-6">
                                                                ...
                                                                <div>
                                                                    <input id="image_6_caption" type="text" name="image_6_caption" class="form-control col-md-6 col-xs-6" placeholder="Caption" value="{{old('image_6_caption', $news->image_6_caption)}}" />
                                                                </div>
                                                    ...
                                                    @if ($news->image_7 != '')
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6 col-sm-6 col-xs-6">
                                                                ...
                                                                <div>
                                                                    <input id="image_7_caption" type="text" name="image_7_caption" class="form-control col-md-6 col-xs-6" placeholder="Caption" value="{{old('image_7_caption', $news->image_7_caption)}}" />
                                                                </div>
                                                    ...
                                                    @if ($news->image_8 != '')
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6 col-sm-6 col-xs-6">
                                                                ...
                                                                <div>
                                                                    <input id="image_8_caption" type="text" name="image_8_caption" class="form-control col-md-6 col-xs-6" placeholder="Caption" value="{{old('image_8_caption', $news->image_8_caption)}}" />
                                                                </div>
                                                    ...
                                                    @if ($news->image_9 != '')
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6 col-sm-6 col-xs-6">
                                                                ...
                                                                <div>
                                                                    <input id="image_9_caption" type="text" name="image_9_caption" class="form-control col-md-6 col-xs-6" placeholder="Caption" value="{{old('image_9_caption', $news->image_9_caption)}}" />
                                                                </div>
                                                    ...
                                                    @if ($news->image_10 != '')
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6 col-sm-6 col-xs-6">
                                                                ...
                                                                <div>
                                                                    <input id="image_10_caption" type="text" name="image_10_caption" class="form-control col-md-6 col-xs-6" placeholder="Caption" value="{{old('image_10_caption', $news->image_10_caption)}}" />
                                                                </div>
